  ...
  **/
  function createRooms() {
    $.each(rooms, function (idx, obj) {
      ...
      var numDiv = $('<div class="roomNum container" id="' + obj.Room_ID + '" style="grid-column: 1; grid-row: ' +
        gridIndex + ' / ' + nextIndex + ';"><div class="numText">' + obj.Room_Number + '</div></div>');
